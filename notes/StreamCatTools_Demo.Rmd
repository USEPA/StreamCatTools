...
## Example One
Get a list of all the available StreamCat metrics via the API
...
## Example Two
Access several variables for several areas of interest and a couple COMIDs.  Loads data into a tibble we can view.
...
```{r Example Five, warning=FALSE, error=FALSE, message=FALSE, fig.width=9}
...
```{r Example Six, warning=FALSE, error=FALSE, message=FALSE}

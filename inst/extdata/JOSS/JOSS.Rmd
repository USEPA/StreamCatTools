...
```{r flowchart, fig.cap="The StreamCat framework: a backend Oracle database, web services exposed through api.gov, and functions in the StreamCatTools which simplify accesss and analyzing the data in R via the API.", echo=FALSE, label="flowchart",  out.width="70%", fig.align="center"}

...
df <- sc_get_data(metric='pctimp2019', aoi='cat', comid=flowline_nldi$UT_flowlines$nhdplus_comid[!flowline_nldi$UT_flowlines$nhdplus_comid %in% c(947090059,947090060)])
